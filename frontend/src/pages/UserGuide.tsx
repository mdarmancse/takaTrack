        ...
        <section className="text-center">
          <div className="card bg-gradient-to-br from-blue-500 to-purple-600 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="btn bg-white text-blue-600 hover:bg-gray-100 btn-lg shadow-lg hover:shadow-xl">
                <span className="flex items-center justify-center">
              ...
              <button className="btn border-2 border-white text-white hover:bg-white hover:text-blue-600 btn-lg shadow-lg hover:shadow-xl">
                <span className="flex items-center justify-center">
